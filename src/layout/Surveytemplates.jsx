...
const Surveytemplates = () => {
  ...
  return (
    <>
      <h1 className='text-center md:text-4xl pt-10 md:pl-60 md:pr-60 sm:text-2xl xs:text-xl bg-white font-sans font-extrabold pb-10 w-full'>Obtain Survey Templates To Aid In Your Initial Steps</h1>
