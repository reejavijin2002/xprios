    ...
    <div className="relative inline-flex">
      ...
      >
         ...
         <div className="flex items-center truncate">
          {/* <span className="truncate ml-2 text-sm font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">XPIROS</span> } */}
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            <div className="font-medium text-slate-800 dark:text-slate-100">XPRIOS</div>
            <div className="text-xs text-slate-500 dark:text-slate-400 italic"></div>
          </div>
          <ul>
            <li>
              <Link
